...
public class ClassdefParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.xtext.ui.contentassist.antlr.internal.InternalClassdefParser createParser() {
		org.eclipse.xtext.ui.contentassist.antlr.internal.InternalClassdefParser result = new org.eclipse.xtext.ui.contentassist.antlr.internal.InternalClassdefParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDummyJavaClassAccess().getGroup(), "rule__DummyJavaClass__Group__0");
					put(grammarAccess.getDummyJavaClassMethodAccess().getGroup(), "rule__DummyJavaClassMethod__Group__0");
					put(grammarAccess.getDummyJavaClassMethodAccess().getGroup_3(), "rule__DummyJavaClassMethod__Group_3__0");
					put(grammarAccess.getDummyJavaClassMethodAccess().getGroup_4(), "rule__DummyJavaClassMethod__Group_4__0");
					put(grammarAccess.getDummyJavaClassMethodParameterAccess().getGroup(), "rule__DummyJavaClassMethodParameter__Group__0");
					...
					put(grammarAccess.getClassDefinitionsAccess().getDefinedClassesAssignment(), "rule__ClassDefinitions__DefinedClassesAssignment");
					put(grammarAccess.getDummyJavaClassAccess().getNameAssignment_1(), "rule__DummyJavaClass__NameAssignment_1");
					put(grammarAccess.getDummyJavaClassAccess().getDescriptionAssignment_2(), "rule__DummyJavaClass__DescriptionAssignment_2");
					put(grammarAccess.getDummyJavaClassAccess().getMethodsAssignment_3(), "rule__DummyJavaClass__MethodsAssignment_3");
					put(grammarAccess.getDummyJavaClassMethodAccess().getNameAssignment_1(), "rule__DummyJavaClassMethod__NameAssignment_1");
					put(grammarAccess.getDummyJavaClassMethodAccess().getDescriptionAssignment_2(), "rule__DummyJavaClassMethod__DescriptionAssignment_2");
					put(grammarAccess.getDummyJavaClassMethodAccess().getInputAssignment_3_1(), "rule__DummyJavaClassMethod__InputAssignment_3_1");
					put(grammarAccess.getDummyJavaClassMethodAccess().getOuputAssignment_4_1(), "rule__DummyJavaClassMethod__OuputAssignment_4_1");
					put(grammarAccess.getDummyJavaClassMethodParameterAccess().getNameAssignment_1(), "rule__DummyJavaClassMethodParameter__NameAssignment_1");
					put(grammarAccess.getDummyJavaClassMethodParameterAccess().getTypeAssignment_3(), "rule__DummyJavaClassMethodParameter__TypeAssignment_3");
					put(grammarAccess.getDummyJavaClassMethodParameterAccess().getDescriptionAssignment_4(), "rule__DummyJavaClassMethodParameter__DescriptionAssignment_4");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.xtext.ui.contentassist.antlr.internal.InternalClassdefParser typedParser = (org.eclipse.xtext.ui.contentassist.antlr.internal.InternalClassdefParser) parser;
			typedParser.entryRuleClassDefinitions();
