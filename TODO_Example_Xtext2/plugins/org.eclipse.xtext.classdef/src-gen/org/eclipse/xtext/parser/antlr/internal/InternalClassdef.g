...
entryRuleClassDefinitions returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getClassDefinitionsRule()); }
	 iv_ruleClassDefinitions=ruleClassDefinitions 
	 { $current=$iv_ruleClassDefinitions.current; } 
	 EOF 
;

// Rule ClassDefinitions
ruleClassDefinitions returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
entryRuleDummyJavaClass returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDummyJavaClassRule()); }
	 iv_ruleDummyJavaClass=ruleDummyJavaClass 
	 { $current=$iv_ruleDummyJavaClass.current; } 
	 EOF 
;

// Rule DummyJavaClass
ruleDummyJavaClass returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='class' 
...
entryRuleDummyJavaClassMethod returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDummyJavaClassMethodRule()); }
	 iv_ruleDummyJavaClassMethod=ruleDummyJavaClassMethod 
	 { $current=$iv_ruleDummyJavaClassMethod.current; } 
	 EOF 
;

// Rule DummyJavaClassMethod
ruleDummyJavaClassMethod returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='action' 
...
entryRuleDummyJavaClassMethodParameter returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDummyJavaClassMethodParameterRule()); }
	 ...
	 { $current=$iv_ruleDummyJavaClassMethodParameter.current; } 
	 EOF 
;

// Rule DummyJavaClassMethodParameter
ruleDummyJavaClassMethodParameter returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='param' 
