...
public class ClassdefSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ClassdefGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (ClassdefGrammarAccess) access;
